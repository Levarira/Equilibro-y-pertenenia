    ...
    <div class="row ">
      ...
      <div class="col-md-7 px-3">
        <div class="card-block px-6">
          <h4 class="card-title" style="font-family: 'Courier New', Courier, monospace; color:black;">Que son las habilidades sociales</h4>
...
<br>
		...
		<div class="container">
			...
			<span>
				<h3 style="text-align: center; font-family: cursive;">Como Mejorar Tus Habilidades Sociales</h3>
			</span>
				...
				<div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
					...
					<div class="card rounded shadow-sm border-0">
						<div class="card-body p-4"><img src="https://www.dropbox.com/s/d1ec8lrd5hspdxn/imag1.svg?raw=1" alt="" class="img-fluid d-block mx-auto mb-3">
							<h5> <a class="text-dark" style="font-family: cursive;">Practicar La Empatia</a></h5>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
					...
					<div class="card rounded shadow-sm border-0">
						<div class="card-body p-4"><img src="https://www.dropbox.com/s/q4u6z21bmxhar1e/imag2.svg?raw=1" alt="" class="img-fluid d-block mx-auto mb-3">
							<h5> <a class="text-dark" style="font-family: cursive;">Escuchar Activamente</a></h5>
