...
<body>
    ...
    <dd> ¿Cómo podemos aplicar la comunicación efectiva? </dd> 
    <p>
    ...
    <br>
    <dd> ¿Cuáles son las características de la comunicación efectiva? </dd> 

    <Ul class="listas">
    <Li> completo que es el mensaje </Li>
    <Li> La claridad e integridad del mensaje </Li>
    <Li> Mensajes Concisos </Li>
    <Li>Consideración del entorno físico y receptor. </Li>
    <Li>La estructura del mensaje. </Li>
    <Li>El mensaje sin errores de gramática ni ortográficos. </Li>
    <Li>El mensaje es de importancia para el receptor</Li>        
    <br>
    <dd> Comprenda claramente los objetivos funcionales de estos elementos: </dd> 
    <br>
    <Li>El remitente es responsable de codificar el mensaje. Recibí la noticia. </Li>
    <Li>El destinatario es la persona que decodifica el mensaje. Recibe el mensaje. </Li>
    <Li>Los mensajes son información codificada en el idioma, ya sea verbal o no verbal.</Li>
    <Li>El código es una colección de símbolos y especificaciones de idiomas, controlados por dos agentes. Comunicación, emisor y receptor.</Li>
    <Li>El canal se utiliza para obtener la información que se ha codificado, se puede Formal e informal.</Li>
    <Li>El contexto es un elemento externo al lenguaje, es decir, que permite al receptor comunicarse.</Li>
    <br>
    <dd> Tipos de comunicación efectiva</dd>
    <br>
    <ul class="listas"></ul>
    <Li> Comunicación formal: se utiliza con todos los protocolos o normas profesionales. </Li>
    <Li> Comunicación informal: en esta comunicacion no hay protocolos; se utiliza para solo brindar un mensaje.</Li>
    <Li> Comunicación ascendente: esta se rige por la jerarquia del subalterno dirijiendose al superior.</Li>
    <Li> comunicación descendente: esta es la contra parte de la comunicación ascendente ya que esta comunicacion la realiza el superior a sus subalternos.</Li>
    <Li> Comunicación horizontal: a diferencia de las dos anteriores esta se da en tre personas del mismo nivel sea educativo laboral o social.</Li>
    <br> 
    <dd> Diferencia y relacionentre la comunicación efectiva y la comunicación asertiva</dd>
    <br>
